...
@implementation RAPhotoBrowserAppDelegate

@synthesize window = _window,
			viewController = _viewController,
			networkUnavailableAlert = _networkUnavailableAlert;
...
{
    Reachability *r = [Reachability reachabilityWithHostName:kRobotangelCarbonMadeURL];
...
- (void)setupViews
{
	_viewController = [[RAMainViewController alloc] init];
	_nc = [[UINavigationController alloc] initWithRootViewController:_viewController];
	[_nc setNavigationBarHidden:YES];
